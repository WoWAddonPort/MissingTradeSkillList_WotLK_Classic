...
hooksecurefunc(MTSLUI_SAVED_VARIABLES, "ResetMinimap", function() MTSLUI_PLAYER.MINIMAP.ACTIVE = 0; MTSLUI_MINIMAP:Hide(); end);

hooksecurefunc(MTSLUI_SAVED_VARIABLES, "ValidateMinimap", function() MTSLUI_PLAYER.MINIMAP.ACTIVE = 0; MTSLUI_MINIMAP:Hide(); end);
